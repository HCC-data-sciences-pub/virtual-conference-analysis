...
line = (
    ...
    .add_yaxis("BioC2018", list(BioC2018.values()),label_opts=opts.LabelOpts(font_size=40),linestyle_opts=opts.LineStyleOpts(width=3,),color="purple")
    .add_yaxis("BioC2019", list(BioC2019.values()),label_opts=opts.LabelOpts(font_size=40),linestyle_opts=opts.LineStyleOpts(width=3,),color="pink")
    .add_yaxis("BioC2020", list(BioC2020.values()),label_opts=opts.LabelOpts(font_size=40),linestyle_opts=opts.LineStyleOpts(width=3,),color="black")
