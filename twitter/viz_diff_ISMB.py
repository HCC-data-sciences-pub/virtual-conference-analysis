...
line = (
    ...
    .add_yaxis("AACR2016", list(ISMB2016.values()),label_opts=opts.LabelOpts(font_size=40),linestyle_opts=opts.LineStyleOpts(width=3,),color="green")
    ...
    .add_yaxis("AACR2018", list(ISMB2018.values()),label_opts=opts.LabelOpts(font_size=40),linestyle_opts=opts.LineStyleOpts(width=3,),color="yellow")
    ...
    .add_yaxis("AACR2020", list(ISMB2020.values()),label_opts=opts.LabelOpts(font_size=40),linestyle_opts=opts.LineStyleOpts(width=3,),color="cyan")
