...
line = (
    ...
    .add_yaxis("AACR2017", list(AACR2017.values()),label_opts=opts.LabelOpts(font_size=40),linestyle_opts=opts.LineStyleOpts(width=3,),color="green")
    ...
    .add_yaxis("AACR2019", list(AACR2019.values()),label_opts=opts.LabelOpts(font_size=40),linestyle_opts=opts.LineStyleOpts(width=3,),color="purple")
    .add_yaxis("AACR2020", list(AACR2020.values()),label_opts=opts.LabelOpts(font_size=40),linestyle_opts=opts.LineStyleOpts(width=3,),color="cyan")
    .add_yaxis("AACR2021", list(AACR2021.values()),label_opts=opts.LabelOpts(font_size=40),linestyle_opts=opts.LineStyleOpts(width=3,),color="orange")
