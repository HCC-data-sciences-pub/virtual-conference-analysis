...
data = pd.read_csv("data\RECOM2019\RECOMB2019_participants.csv", index_col=False)
...
c = (
        ...
        .set_global_opts(
            title_opts=opts.TitleOpts(title="Conference 2019 Geographics",
            subtitle="",
            pos_left="center",
            pos_top="top"),
...
grid_chart = (
    Grid(init_opts=opts.InitOpts(width="2000px",renderer="svg",height='1400px',page_title="RECOMB 2019 Geographics"))
    .add(
        bar,
    ...
    .render("data\RECOM2019\RECOM2019.html")
)

# make_snapshot(snapshot,"data\RECOM2019\RECOM2019.html","data\RECOM2019\RECOM2019.svg")
