...
bar = (
        ...
        .set_global_opts(
            xaxis_opts=opts.AxisOpts(
                max_=100, axislabel_opts=opts.LabelOpts(is_show=False),axistick_opts=opts.AxisTickOpts(is_show=False)
            ),
...
grid_chart = (
    Grid(init_opts=opts.InitOpts(width="2000px",height='1400px',page_title="BCC 2020 Geographics"))
    .add(
        bar,
        grid_opts=opts.GridOpts(
            pos_left="10", pos_right="35%", pos_top="40%", pos_bottom="5"
        ),
    )
