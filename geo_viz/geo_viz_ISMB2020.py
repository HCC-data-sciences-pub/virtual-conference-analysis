...
data = pd.read_csv("data\ISMB2020\ISMB2020_participants.csv", index_col=False)
...
c = (
        ...
        .set_global_opts(
            title_opts=opts.TitleOpts(title="ISMB2020 Geographics"),
            visualmap_opts=opts.VisualMapOpts(max_=900),
        )
        .render("data\ISMB2020\ISMB2020.html")
    )
